...
style={
              widget.tint
                ? { backgroundColor: `color-mix(in oklab, ${tintVar(widget.tint)} 80%, white 20%)` }
                : undefined
            }
...
? `color-mix(in oklab, ${tintVar(widget.tint)} 68%, white 32%)`
                      : `color-mix(in oklab, ${tintVar(widget.tint)} 80%, white 20%)`,
                  }
                : undefined
            }
